                        ...
                        <form
                            ...
                            <div class="relative flex h-full flex-1 md:flex-col">
                                ...
                                <div
                                    ...
                                    <textarea tabindex="0" data-id="root" onInput={textareaAutoHeight} onKeyDown={textaeraEnter} onChange={e => setText(e.target.value)} value={text()}
                                        style="max-height: 200px; height: 24px; overflow-y: hidden;" rows="1"
                                        placeholder=""
                                        class="outline-none m-0 w-full resize-none border-0 bg-transparent p-0 pl-2 pr-7 focus:ring-0 focus-visible:ring-0 dark:bg-transparent md:pl-0"></textarea>
                                    <button onClick={commitQuestion} type="button"
